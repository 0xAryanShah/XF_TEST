(function(a) {
			...
			return (
				...
				(c.i = function(a, b) {
					...
					for (var g, h = 0; h < a.length; h++)
						(g = a[h]),
							(null != g[0] && e[g[0]]) ||
								(b && !g[2] ? (g[2] = b) : b && (g[2] = '('.concat(g[2], ') and (').concat(b, ')')),
								c.push(g));
				}),
				c
			);
	...
	function(a, b, c) {
		...
		a.exports = function(a, b) {
			(b = b || {}),
				(b.attributes = 'object' == typeof b.attributes ? b.attributes : {}),
				b.singleton || 'boolean' == typeof b.singleton || (b.singleton = j());
			var c = d(a, b);
			return (
				e(c, b),
				function(a) {
	...
	function(a, b, c) {
		...
		class e extends HTMLElement {
			constructor(a) {
				super(),
					(a = a || {}),
					(this.count = a.count || 3),
					(this.size = a.size || { width: '15px', height: '15px' }),
					(this.minAge = a.minAge || 2e3),
					(this.maxAge = a.maxAge || 5e3);
				...
				if (
					(a.starsource &&
						('string' == typeof a.starsource ? (b = a.starsource) : (this.starsource = a.starsource)),
					!this.starsource)
				) {
					let a = document.createElement('div');
					(a.style.display = 'block'),
						(a.innerHTML = b),
						(a.width = this.size.width),
